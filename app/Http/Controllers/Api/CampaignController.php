...
use App\Services\CampaignService as Service;
...
class CampaignController extends Controller
{
    ...
    {   
        /* if($request->campaign_uuid && $request->product_uuid ){
            return $data->addProduct($request->campaign_uuid, $request->product_uuid);
        } */
